[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.21009708.svg)](https://doi.org/10.5281/zenodo.21009708)

## Table of Contents

1. [Overview](#1-overview)
2. [Citation](#2-citation)
3. [Architecture & Data Flow](#2-architecture--data-flow)
4. [Global Configuration Flags](#3-global-configuration-flags)
5. [Tire Modeling](#4-tire-modeling)
6. [Vehicle Bodies](#5-vehicle-bodies)
7. [Hitch Coupling & Articulation](#6-hitch-coupling--articulation)
8. [Time Integration & Solvers](#7-time-integration--solvers)
9. [Active Safety Systems](#8-active-safety-systems)
10. [Steering & Speed Control](#9-steering--speed-control)
11. [Suspension & Vertical Dynamics](#10-suspension--vertical-dynamics)
12. [Simulation Main Loop](#11-simulation-main-loop)
13. [Output & Data Export](#12-output--data-export)
14. [Key Equations Reference](#13-key-equations-reference)
...
If you use this vehicle model in your research, please cite it as:
...
### 5.1 Pacejka Magic Formula (`PacejkaTire`, L1684)
...
### 5.2 Tire Relaxation (`TireRelaxationDynamics`, L2004)
...
### 5.3 Tire Saturation Mode (`TIRE_SATURATION_MODE`)
...
## 8. Time Integration & Solvers

### 8.1 Backward Euler (Legacy, `USE_GENERALIZED_ALPHA = False`)
...
### 8.2 Generalized-α (Default, `USE_GENERALIZED_ALPHA = True`)
...
### 8.4 Automatic Timestep Calculation (`compute_optimal_dt`, L291)
...
### 8.5 CoupledVehicleSystem (L7681)
...
## 9. Active Safety Systems

### 9.1 ABS — Anti-Lock Braking (`ABSController`)
...
### 9.2 TCS — Traction Control (`TCSController`)
...
### 9.3 ESC — Electronic Stability Control (`ESCController`)
...
### 9.4 RSC — Roll Stability Control (`RollStabilityController`)
...
### 9.5 Pneumatic Brake Delay (`PneumaticBrakeSystem`)
...
## 10. Steering & Speed Control

### 10.1 MPC Steering Controller (`MPCSteeringController`, L778)
...
### 10.2 EKF State Estimator (`VehicleEKF`, L1200)
...
### 10.3 PID Speed Controller (inside `Controller2D`, L8036)
...
### 10.4 Fallback: Stanley Controller
...
## 11. Suspension & Vertical Dynamics

### 11.1 Quarter-Car Model (`QuarterCarSuspension`)
...
## 12. Simulation Main Loop (`main()`, L8489)
